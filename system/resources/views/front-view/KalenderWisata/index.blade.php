            ...
            <head>
                ...
                <link rel="stylesheet" type="text/css"
                    href="{{ url('public') }}/assets-web/revolution/css/settings.css">
                <link rel="stylesheet" type="text/css" href="{{ url('public') }}/assets-web/revolution/css/layers.css">
                <link rel="stylesheet" type="text/css"
                    href="{{ url('public') }}/assets-web/revolution/css/navigation.css">
            ...
            <body>
                ...
                <div class="wrapper">
                    ...
                    <nav
                        ...
                        <!--== Start Top Search ==-->
                        <div class="fullscreen-search-overlay" id="search-overlay"> <a href="#"
                                class="fullscreen-close" id="fullscreen-close-button"><i
                        ...
                        <div class="container">
                            ...
                            <div class="navbar-header">
                                ...
                                <div class="logo"> <a href="{{ url('DesaWisata') }}"><img class="logo logo-display"
                                            ...
                                            src="{{ url('public') }}/assets-web/images/logo/maskot-itam.png"
                                            alt="" style="width: 100%; object-fit:contain"> </a>
                                </div>
                            </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbar-menu">
                                <ul class="nav navbar-nav" data-in="fadeIn" data-out="fadeOut">
                                    ...
                                    <li><a class="page-scroll" href="{{ url('PetaWisata') }}">Peta
                                            Wisata</a></li>
                                    <li><a class="page-scroll" href="{{ url('Kontak') }}">Info & Kontak</a>
                                    </li>
                                    {{-- <li><a class="page-scroll" href="{{ url('auth/login') }}"><i
                                                class="icofont-user-male"></i></a>
                                    </li> --}}
                                </ul>
                            </div>
                            <!--== /.navbar-collapse ==-->
                    ...
                    <div class="remove-padding transition-none" id="home">
                        <div id="rev_slider_1078_2_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
                            ...
                            <div id="rev_slider_1078_2" class="rev_slider fullwidthabanner" style="display:none;"
                                ...
                                <ul>
                                    <!-- SLIDE  -->
                                    <li data-index="rs-3045" data-transition="slotfade-vertical"
                                        ...
                                        <div class="hero-text-wrap">
                                            <center>
                                                <h3 style="color: white; font-weight:40px; margin-top:45vh">Kalender
                                                    Wisata</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">Januari</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/1.jpeg"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                        ...
                                        <div class="select-menu">
                                            <div class="select-btn">
                                                <p class="sBtn-text">Lihat List Event</p>
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">Februari</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/2.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">Maret</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/3.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">April</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/4.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">Mei</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/5.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">Juni</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/6.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                        <hr class="grey-bg">
                                        <div class="select-menu6">
                                            <div class="select-btn6">
                                                <p class="sBtn-text">Lihat List Event</p>
                                                <i class="icofont-simple-down"></i>
                                            </div>
                                            <ul class="options">
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">Juli</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/7.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                        <hr class="grey-bg">
                                        <div class="select-menu7">
                                            <div class="select-btn7">
                                                <p class="sBtn-text">Lihat List Event</p>
                                                <i class="icofont-simple-down"></i>
                                            </div>
                                            <ul class="options">
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">Agustus</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/8.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                        <hr class="grey-bg">
                                        <div class="select-menu8">
                                            <div class="select-btn8">
                                                <p class="sBtn-text">Lihat List Event</p>
                                                <i class="icofont-simple-down"></i>
                                            </div>
                                            <ul class="options">
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">September</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/9.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                        <hr class="grey-bg">
                                        <div class="select-menu9">
                                            <div class="select-btn9">
                                                <p class="sBtn-text">Lihat List Event</p>
                                                <i class="icofont-simple-down"></i>
                                            </div>
                                            <ul class="options">
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">Oktober</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/10.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                        <hr class="grey-bg">
                                        <div class="select-menu10">
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">November</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/11.jfif"
                                                alt="" style="object-fit: cover">
                                        </a>
                                        <br>
                                        <br>
                                        <hr class="grey-bg">
                                        <div class="select-menu11">
                                            <div class="select-btn11">
                                                <p class="sBtn-text">Lihat List Event</p>
                                                <i class="icofont-simple-down"></i>
                                            </div>
                                            <ul class="options">
                                ...
                                <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
                                    <div class="date-box dark-bg text-center">
                                        <span style="color: white" class="day">Desember</span>
                                    </div>
                                    <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">
                                        <a><img style="width:100%; height:200px; object-fit: cover"
                                                src="{{ url('public') }}/assets-web/images/kalender/12.jfif"
                                                alt="">
                                        </a>
                                        <br>
                                        <br>
                                        <hr class="grey-bg">
                                        <div class="select-menu12">
                                            <div class="select-btn12">
                                                <p class="sBtn-text">Lihat List Event</p>
                                                <i class="icofont-simple-down"></i>
                                            </div>
                                            <ul class="options">
                            ...
                            <div class="container">
                                <div class="row wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="col-md-8 centerize-col text-center">
                                        ...
                                        <div class="copy-right">Copyright &copy; <span class="default-color">E-KTG
                                                2022
                                                @if (date('Y') > '2022')
                                                    -{{ date('Y') }}
                                                @endif.
