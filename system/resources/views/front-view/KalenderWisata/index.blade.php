	...
	<div id="rev_slider_1078_2" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
      <ul>	<!-- SLIDE  -->
      	<li data-index="rs-3045" data-transition="slotfade-vertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
      		<!-- MAIN IMAGE -->
      		<img src="{{url('public')}}/assets-web/images/post/kalender.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
      		<!-- LAYERS -->
        ...
        <div class="row">
          ...
          <div class="col-md-4 pricing-table col-sm-4 xs-mb-30 mt-50">
            ...
            <div class="pricing-box pricing-box-bg  wow fadeInLeft" data-wow-delay="0.1s">             
				<a href="{{url('front-view/KalenderWisata', $kalender_wisata->id)}}"><img style="width:100%; height:200px; object-fit: cover" src="{{url("public/$kalender_wisata->foto")}}" alt=""> </a>
				<h5>{{$kalender_wisata->nama}}</h5>
				<i class="icofont-ui-calendar"> {!!date('d, M Y', strtotime($kalender_wisata->tanggal)) !!}</i> <i class="icofont-location-pin">  {{$kalender_wisata->tempat}}</i>	
				<br>
				<br>
				{!! substr(nl2br ($kalender_wisata->isi),0,100,) !!}..... <a href="{{url('front-view/KalenderWisata', $kalender_wisata->id)}}"><i class="icofont-rounded-double-right" style="color: #000000"></i></a>
            </div>
          </div>
		  	@endforeach    
        </div>
