...
<div class="wrapper">
  ...
  <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav on no-full no-border">
    ...
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <div class="logo"> <a href="{{url('desaWisata')}}"><img class="logo logo-display" src="{{url('public')}}/assets-web/images/logo-white.png" alt=""> <img class="logo logo-scrolled" src="{{url('public')}}/assets-web/images/logo-black.png" alt=""> </a> </div>
      </div>
          ...
          <div class="post-wrap">
            <div class="post-img">
              ...
              <div class="blog-grid-slider slick">
                <div class="item"><a href="#"><img class="img-responsive" src="{{url('public')}}/assets-web/images/post/1.jpg" alt=""/></a></div>
                <div class="item"><a href="#"><img class="img-responsive" src="{{url('public')}}/assets-web/images/post/2.jpg" alt=""/></a></div>
				<div class="item"><a href="#"><img class="img-responsive" src="{{url('public')}}/assets-web/images/post/3.jpg" alt=""/></a></div>
				<div class="item"><a href="#"><img class="img-responsive" src="" alt="Tidak Dapat Memuat Gambar"/></a></div>
              </div>
            </div>
            <div class="post-text">
  ...
  <section class="grey-bg pb-0" id="work">
    <div class="container">
      <div class="row">
        <div class="col-md-8 centerize-col text-center">
          <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="raleway-font"><span class="font-100">Our</span> Works</h1>
            <hr class="center_line dark-bg">
          </div>
        </div>
      </div>
          ...
          <div id="portfolio-gallery" class="cbp">
              <div class="cbp-item branding col-md-3 col-sm-3">
                  <div class="portfolio gallery-image-hover text-center">
                  	...
                  	<img src="{{url('public')}}/assets-web/images/portfolio/grid/1.jpg" alt="">
              ...
              <div class="cbp-item branding web-design col-md-3 col-sm-3">
                  <div class="portfolio gallery-image-hover text-center">
                  	<div class="folio-overlay"></div>
                  	<img src="{{url('public')}}/assets-web/images/portfolio/grid/2.jpg" alt="">
                  	<div class="portfolio-wrap">
               	  		  <div class="portfolio-description">
              ...
              <div class="cbp-item web-design print col-md-3 col-sm-3">
                  <div class="portfolio gallery-image-hover text-center">
                  	<div class="folio-overlay"></div>
                  	<img src="{{url('public')}}/assets-web/images/portfolio/grid/3.jpg" alt="">
                  	<div class="portfolio-wrap">
               	  		  <div class="portfolio-description">
              ...
              <div class="cbp-item web-design advertising col-md-3 col-sm-3">
                  <div class="portfolio gallery-image-hover text-center">
                  	<div class="folio-overlay"></div>
                  	<img src="{{url('public')}}/assets-web/images/portfolio/grid/4.jpg" alt="">
                  	<div class="portfolio-wrap">
               	  		  <div class="portfolio-description">
              ...
              <div class="cbp-item photography col-md-3 col-sm-3">
                  <div class="portfolio gallery-image-hover text-center">
                  	<div class="folio-overlay"></div>
                  	<img src="{{url('public')}}/assets-web/images/portfolio/grid/5.jpg" alt="">
                  	<div class="portfolio-wrap">
               	  		  <div class="portfolio-description">
              ...
              <div class="cbp-item web-design col-md-3 col-sm-3">
                  <div class="portfolio gallery-image-hover text-center">
                  	<div class="folio-overlay"></div>
                  	<img src="{{url('public')}}/assets-web/images/portfolio/grid/6.jpg" alt="">
                  	<div class="portfolio-wrap">
               	  		  <div class="portfolio-description">
              ...
              <div class="cbp-item photography advertising col-md-3 col-sm-3">
                  <div class="portfolio gallery-image-hover text-center">
                  	<div class="folio-overlay"></div>
                  	<img src="{{url('public')}}/assets-web/images/portfolio/grid/7.jpg" alt="">
                  	<div class="portfolio-wrap">
               	  		  <div class="portfolio-description">
              ...
              <div class="cbp-item web-design col-md-3 col-sm-3">
                  <div class="portfolio gallery-image-hover text-center">
                  	<div class="folio-overlay"></div>
                  	<img src="{{url('public')}}/assets-web/images/portfolio/grid/8.jpg" alt="">
                  	<div class="portfolio-wrap">
               	  		  <div class="portfolio-description">
  ...
  <!--== Services Start ==-->
  <section class="white-bg pb-70" id="service">
    <div class="container">
      <div class="row">
        <div class="col-md-8 centerize-col text-center">
          <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="raleway-font"><span class="font-100">Our</span> Services</h1>
            <hr class="center_line dark-bg">
          </div>
        </div>
      </div>
      ...
      <div class="row mt-50">
        ...
        <div class="col-md-4 xs-mt-80 sm-mt-80 wow zoomIn" data-wow-delay="0.4s">
   	    	<img class="img-responsive pt-20" src="{{url('public')}}/assets-web/images/iphone-4.png" alt="">
   	    </div>
        <div class="col-md-4">
              ...
              <h3 class="mt-0">Awesome Friendly</h3>
            ...
            <div class="feature-box text-left mb-50 wow fadeInLeft" data-wow-delay="0.6s">
              ...
              <h3 class="mt-0">Revolution Slider</h3>
              <p class="font-300">Nunc pharetra ullamcorper enim eget interdum. Morbi vitae pulvinar lacus. Suspendisse pulvinar tempus hendrerit. Suspendisse quam felis.</p>
            </div>
            <div class="feature-box text-left mb-50 wow fadeInLeft" data-wow-delay="0.7s">
              ...
              <h3 class="mt-0">Quick Response</h3>
              <p class="font-300">Nunc pharetra ullamcorper enim eget interdum. Morbi vitae pulvinar lacus. Suspendisse pulvinar tempus hendrerit. Suspendisse quam felis.</p>
            </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="client-slider slick">
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-1-light.png" alt="01"/> </div>
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-2-light.png" alt="02"/> </div>
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-3-light.png" alt="03"/> </div>
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-4-light.png" alt="04"/> </div>
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-5-light.png" alt="05"/> </div>
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-6-light.png" alt="06"/> </div>
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-7-light.png" alt="07"/> </div>
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-8-light.png" alt="08"/> </div>
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-9-light.png" alt="09"/> </div>
          <div class="client-logo"> <img class="img-responsive" src="{{url('public')}}/assets-web/images/clients/client-img-10-light.png" alt="10"/> </div>
        </div>
      </div>
    </div>
  </div>
  ...
  <!--== About Company Start ==-->
  <div class="grey-bg pt-0 pb-0 about-section">
    <div class="col-md-6 col-sm-6 bg-flex bg-flex-left">
      <div class="bg-flex-holder bg-flex-cover" style="background-image: url({{url('public')}}/assets-web/images/bg-left-img-2.jpg);">
    ...
    <div class="container-fluid">
      <div class="col-md-6 col-sm-6 col-md-offset-6 col-sm-offset-6">
          <div class="col-inner spacer text-left wow fadeInLeft" data-wow-delay="0.1s">
            ...
            <h2 class="raleway-font"><span class="font-100">About</span> <br>Our Company</h2>
            ...
            <p class="mt-30">
              <a class="btn btn-lg btn-dark-outline btn-square btn-zoom"><i class="icofont icofont-briefcase-2 mr-10"></i> Our Work</a>
              <a class="btn btn-lg btn-dark btn-square btn-zoom"><i class="icofont icofont-ui-message mr-10"></i> Contact Us</a>
            </p>
          </div>
          </div>
        </div>
  ...
  <!--== Who We Are Start ==-->
  <div class="dark-bg pt-0 pb-0 about-section">
    <div class="col-md-6 col-sm-6 bg-flex bg-flex-right">
      <div class="bg-flex-holder bg-flex-cover" style="background-image: url({{url('public')}}/assets-web/images/bg-left-img.jpg);"></div>
    </div>
    <div class="container-fluid">
      <div class="col-md-6 col-sm-6">
          <div class="col-inner spacer text-left wow fadeInRight" data-wow-delay="0.2s">
            <div class="mission-section">
            <h2 class="raleway-font white-color"><span class="font-100">Our</span> <br>Awesome Features</h2>
            ...
            <p class="mt-30">
              <a class="btn btn-lg btn-light-outline btn-square btn-zoom"><i class="icofont icofont-briefcase-2 mr-10"></i> Our Work</a>
              <a class="btn btn-lg btn-color-outline btn-square btn-zoom"><i class="icofont icofont-ui-cart mr-10"></i> Buy template</a>
            </p>
          </div>
          </div>
        </div>
  ...
  <section class="white-bg" id="contact">
    <div class="container">
      <div class="row">
        <div class="col-md-8 centerize-col text-center">
          <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="raleway-font"><span class="font-100">Contact</span> Us</h1>
            <hr class="center_line dark-bg">
          </div>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="email" name="email" class="md-input" id="email" required data-error="Please Enter Valid Email">
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-md-12 col-sm-12">
                <div class="form-group">
                  ...
                  <textarea name="message" class="md-textarea" id="message" rows="7" required data-error="Please, Leave us a message"></textarea>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-md-12 col-sm-12">
                <div class="text-left">
                  <button type="submit" name="submit" class="btn btn-dark btn-md btn-square btn-animate remove-margin btn-zoom"><span>Send <i class="ion-android-arrow-forward"></i></span></button>
                </div>
              </div>
            </div>
          </form>
      ...
      <div class="container">
        <div class="row wow fadeInUp" data-wow-delay="0.1s">
          <div class="col-md-8 centerize-col text-center">
            ...
            <div class="copy-right">© 2019 <span class="default-color">Sylphy.</span> All rights reserved</div>
