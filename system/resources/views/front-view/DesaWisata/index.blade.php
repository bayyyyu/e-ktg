            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav" data-in="fadeIn" data-out="fadeOut">
                        <li><a class="page-scroll actives" href="{{ url('front-view/DesaWisata') }}"
                                data-toggle="dropdown">Desa Wisata</a></li>
                                    ...
                                    <div class="blog-grid-slider slick">
                                        ...
                                        <div class="item"><a class="image-popup-no-margins"
                                                href="{{ url("public/$desa_wisata->foto_2") }}"><img
                                                    class="img-responsive"
                                                    style="width:400px; height:300px; object-fit: cover"src="{{ url("public/$desa_wisata->foto_2") }}"
                                                    alt="Tidak Dapat Memuat Gambar" /></a></div>
                                        <div class="item"><a class="image-popup-no-margins"
                                                href="{{ url("public/$desa_wisata->foto_3") }}"><img
                                                    class="img-responsive"
                                                    style="width:400px; height:300px; object-fit: cover"src="{{ url("public/$desa_wisata->foto_3") }}"
                                                    alt="Tidak Dapat Memuat Gambar" /></a></div>
                                        <div class="item"><a class="image-popup-no-margins"
                                                href="{{ url("public/$desa_wisata->foto_4") }}"><img
                                                    class="img-responsive"
                                                    style="width:400px; height:300px; object-fit: cover"src="{{ url("public/$desa_wisata->foto_4") }}"
                                                    alt="Tidak Dapat Memuat Gambar" /></a></div>
                                    </div>
                                </div>
