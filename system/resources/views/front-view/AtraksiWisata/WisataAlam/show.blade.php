                            ...
                            <div class="page-title text-center white-color">
                                ...
                                <div class="breadcrumb mt-20">
                                    ...
                                    <ul>
                                        ...
                                        <li><a
                                                href="{{ url('AtraksiWisata/WisataAlam') }}">{{ $atraksi_wisata->kategori }}</a>
                                        </li>
                                        <li>Blog Details</li>
                                    </ul>
                                    <!-- Breadcrumb End -->
                        ...
                        @foreach ($recent_upload->where('kategori', 'Wisata Alam') as $atraksi_wisata)
                            <div class="post-item">
                                ...
                                <div class="post-thumb">
                                    <a href="{{ url('AtraksiWisata/WisataAlam', $atraksi_wisata->id) }}"><img width="75" height="75"
                                            src="{{ url("public/$atraksi_wisata->foto") }}" style="object-fit:cover"
                                            class="img-responsive" alt="post-01" /></a>
                                </div>
                                <div class="post-body">
                                    <span class="font-18px"><a
                                            href="{{ url('AtraksiWisata/WisataAlam', $atraksi_wisata->id) }}">{{ $atraksi_wisata->nama }}</a></span>
