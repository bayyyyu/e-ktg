    ...
    <div class="wrapper">
                            ...
                            <div class="page-title text-center white-color">
                                ...
                                <div class="breadcrumb mt-20">
                                    ...
                                    <ul>
                                        ...
                                        <li><a
                                                href="{{ url('front-view/AtraksiWisata/WisataAlam') }}">{{ $atraksi_wisata->kategori }}</a>
                                        </li>
                                        <li>Blog Details</li>
                                    </ul>
                                    <!-- Breadcrumb End -->
        ...
        <section class="white-bg">
            <div class="container">
                <div class="row">
                    ...
                    <div class="sidebar_widget widget_recent_post mb-50 col-md-3 col-sm-3 col-xs-12">
                        ...
                        @foreach ($recent_upload->where('kategori', 'Wisata Alam') as $atraksi_wisata)
                            <div class="post-item">
                                ...
                                <div class="post-body">
                                    <span class="font-14px"><a
                                            href="{{ url('front-view/AtraksiWisata/WisataAlam') }}">{{ $atraksi_wisata->kategori }}</a></span>
                                    <div class="post-time">{{ $atraksi_wisata->created_at->diffForHumans() }}</div>
                                    <a href="{{ url('front-view/AtraksiWisata/WisataAlam', $atraksi_wisata->id) }}"
                                        class="subtitle">{{ $atraksi_wisata->nama }}</a>
                                </div>
                            </div>
                        @endforeach
                    </div>
            ...
            <div id='share-button'>
                ...
                <a href="whatsapp://send?text= echo site_url().'first/artikel/'.$single_artikel['id']" rel='nofollow'
                    style='background:#4dc247;' target='_blank' title='Whatsapp'><svg viewBox='0 0 24 24'>
                        <path
                ...
                <a &lt;a id="button"
                    onClick="window.open('http://www.facebook.com/sharer.php?s=100&amp;amp;p[title]=&lt;?php echo $title; ?&gt;&amp;amp;p[summary]=&lt;?php echo $summary;?&gt;&amp;amp;p[url]=&lt;?php echo $url; ?&gt;&amp;amp;&amp;p[images][0]=&lt;?php echo $image;?&gt;', 'sharer', 'toolbar=0,status=0,width=550,height=400');"
                    target="_parent" href="javascript: void(0)"&gt; &lt;img src="images/f.jpg" /&gt;&lt;/a&gt;
                    rel='nofollow' style='background:#3b5998;' target='_blank' title='Facebook'><svg
                        viewBox='0 0 24 24'>
                        <path
                ...
                <!-- untuk tobol Twitter -->
                <a &lt;a
                    href="http://twitter.com/share?source=sharethiscom&amp;text=&lt;?php echo $title;?&gt;&amp;url=&lt;?php echo $url; ?&gt;&amp;via=berbagiyuks"&gt;&lt;img
                    src="images/tw.jpg" /&gt;&lt;/a&gt; rel='nofollow' style='background:#4099ff;' target='_blank'
                    title='Twitter'><svg viewBox='0 0 24 24'>
                        <path
                ...
                <a &lt;a
                    href="http://www.linkedin.com/shareArticle?mini=true&amp;url=&lt;?php echo $url; ?&gt; &amp;title=&lt;?php echo $title;?&gt;&amp;summary=&lt;?php echo $summary;?&gt;&amp;source=BerbagiYuks.con"rel="nofollow"&gt;&lt;img
                    src="images/in.jpg" /&gt;&lt;/a&gt; rel='nofollow' style='background:#2554BF;' target='_blank'
                    title='Linkedin'><svg viewBox='0 0 24 24'>
                        <path
                            d='M21,21H17V14.25C17,13.19 15.81,12.31 14.75,12.31C13.69,12.31 13,13.19 13,14.25V21H9V9H13V11C13.66,9.93 15.36,9.24 16.5,9.24C19,9.24 21,11.28 21,13.75V21M7,21H3V9H7V21M5,3A2,2 0 0,1 7,5A2,2 0 0,1 5,7A2,2 0 0,1 3,5A2,2 0 0,1 5,3Z' />
                    </svg></a>
                <!-- untuk tombol Telegram -->
                <a expr:data-text='data:post.title' expr:data-url='data:post.url'
                    expr:href='&quot;https://telegram.me/share/url?url=&quot; + data:post.url + &quot;&amp;text=Ada%20yang%20keren%20lho,%20nyesel%20kalo%20ga%20buka...%20kunjungi:&quot;'
                    rel='nofollow' style='background: #32afed;' target='_blank' title='Share to Telegram'><svg
                        viewBox='0 0 24 24'>
                        <path
                            d='M9.78,18.65L10.06,14.42L17.74,7.5C18.08,7.19 17.67,7.04 17.22,7.31L7.74,13.3L3.64,12C2.76,11.75 2.75,11.14 3.84,10.7L19.81,4.54C20.54,4.21 21.24,4.72 20.96,5.84L18.24,18.65C18.05,19.56 17.5,19.78 16.74,19.36L12.6,16.3L10.61,18.23C10.38,18.46 10.19,18.65 9.78,18.65Z.083 -0.219,-0.037c-2.5,1.596 -6.939,4.43 -6.939,4.43Z' />
                    </svg></a>
            </div>
