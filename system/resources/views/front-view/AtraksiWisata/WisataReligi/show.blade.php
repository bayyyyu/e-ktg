...
<title>KETAPANG TRAVEL GUIDE - Wisata Religi di Kabupaten Ketapang</title>
...
<ul>	<!-- SLIDE  -->
	<li data-index="rs-3238" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
		<!-- MAIN IMAGE -->
		<img src="{{url('public')}}/assets-web/images/Atraksi Wisata/13.jpg" data-bgcolor="#7F00FF" alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina />
		<!-- LAYERS -->
		...
		<!-- LAYER NR. 1 -->
              ...
              <div class="page-title text-center white-color">
                <h1 class="raleway-font font-300">{{$wisata_religi->nama}}</h1>
                <div class="breadcrumb mt-20">
                    <!-- Breadcrumb Start -->
                        <ul>
                          <li><a href="{{url('front-view/AtraksiWisata')}}">Atraksi Wisata</a></li>
                          <li><a href="{{url('front-view/AtraksiWisata/WisataReligi  ')}}">Wisata Religi</a></li>
                          <li>{{$wisata_religi->nama}}</li>
                        </ul>
                    <!-- Breadcrumb End -->
                </div>
              </div>
  ...
  <div class="grey-bg pt-0 pb-0 about-section mt-50 mb-50">
    ...
    <div class="col-md-6 col-sm-6 bg-flex bg-flex-left ml-80">
      <img src="{{url("public",$wisata_religi->foto)}}" style="width:500px; height:400px; object-fit: cover; " class="bg-flex-holder bg-flex-cover"/>
    </div>
    <div class="container-fluid">
      <div class="col-md-6 col-sm-6 col-md-offset-6 col-sm-offset-6">
          <div class="col-inner spacer text-left wow fadeInLeft" data-wow-delay="0.1s">
            ...
            <h2 class="raleway-font">{{$wisata_religi->nama}}</h2>
            <hr class="left-line dark-bg" />
            <p>
              {{$wisata_religi->deskripsi}}
            </p>
  ...
  <div class="row">
        <div class="col-md-8 centerize-col text-center mt-20">
          <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
            <strong style="font-size: 20px; font-weight:bold">Temukan lebih banyak tempat yang berhubungan dengan Wisata Religi</strong>
            <hr class="center_line grey-bg">
          </div>
        </div>
      </div>

   <div class="slider2 owl-carousel ml-30 mb-50">
        @foreach ($list_wisata_religi as $wisata_religi)
        <div class="card">
          <div class="content">
            <div class="text-center"><a href="{{url('front-view/AtraksiWisata/WisataReligi', $wisata_religi->id) }}">{{$wisata_religi->kategori}}</a></div>
          </div>
          <div class="img"><img src="{{url("public",$wisata_religi->foto)}}" alt="Foto Wisata Rimba"></div>
          <div class="content">
