	...
	<li data-index="rs-3238" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
		...
		<!-- LAYER NR. 1 -->
              ...
              <div class="page-title text-center white-color">
                <h1 class="raleway-font font-300">Wisata Kuliner</h1>
      ...
      <div class="row">
        <div class="col-md-8 centerize-col text-center">
          <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
            <strong style="font-size: 20px; font-weight:bold">WISATA KULINER KABUPATEN KETAPANG</strong>
      ...
      <div class="row">
        ...
        <div class="col-md-4 blog-list wow fadeInDown mt-2" data-wow-delay="0.2s">
          <div class="post-wrap">
            ...
            <h5 class="text-center">{{$wisata_kuliner->kategori}}</h5>
            <div class="post-img">
              {{-- <div class="date-box dark-bg">
                <span class="day">26</span>
                <span class="month">NOV</span>
              </div> --}}
                    <div class="item"><a class="image-popup-no-margins" href="{{url("public",$wisata_kuliner->foto)}}"><img class="img-responsive" style="width:400px; height:300px; object-fit: cover" src="{{url("public",$wisata_kuliner->foto)}}" alt="Tidak Dapat Memuat Gambar"/></a></div>
                 
            </div>
         
            <div class="post-text">
              
              <h3>{{$wisata_kuliner->nama}}</h3>
              <p>
                {!! substr(nl2br ($wisata_kuliner->deskripsi),0,220,) !!}..... <a href="{{url('front-view/AtraksiWisata/WisataKuliner', $wisata_kuliner->id) }}" style="color: blue">selengkapnya</a>
              </p>
			  <hr class="grey-bg">
