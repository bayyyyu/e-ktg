...
<head>
    ...
    <title>KETAPANG TRAVEL GUIDE - Wisata Wisata Buatan di Kabupaten Ketapang</title>
            ...
            <ul>
                ...
                <li data-index="rs-3238" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <div class="page-title text-center white-color">
                        <h1 class="raleway-font font-300">Wisata Buatan</h1>
                ...
                <div class="row">
                    <div class="col-md-8 centerize-col text-center">
                        <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                            <strong style="font-size: 20px; font-weight:bold">WISATA BUATAN KABUPATEN KETAPANG</strong>
                    ...
                    @foreach ($list_atraksi_wisata->where('kategori', 'Wisata Buatan') as $atraksi_wisata)
                        <div class="col-md-4 blog-list wow fadeInDown mt-2" data-wow-delay="0.2s">
                            <div class="post-wrap">
                                ...
                                <div class="post-img">
                                    <div class="item"><a
                                            href="{{ url('AtraksiWisata/WisataBuatan', $atraksi_wisata->id) }}"><img
                                ...
                                <div class="post-text">
                                    ...
                                    <h3><a href="{{ url('AtraksiWisata/WisataBuatan', $atraksi_wisata->id) }}">{{ $atraksi_wisata->nama }}
                                    </h3></a>
                                    {{-- <p>
                                        {!! substr(nl2br($atraksi_wisata->deskripsi), 0, 220) !!}..... <a
                                            href="{{ url('AtraksiWisata/WisataBuatan', $atraksi_wisata->id) }}"
