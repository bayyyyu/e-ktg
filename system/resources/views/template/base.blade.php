...
<link rel="stylesheet" href="{{url('public')}}/css/flexslider.css" type="text/css" media="all" />
<!-- //For Testimonials slider -->
<!-- //custom-theme files-->
...
<!-- //font-awesome-icons -->
<!-- googlefonts -->
<link href="{{url('public')}}//fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i&amp;subset=cyrillic,cyrillic-ext,greek,greek-ext,latin-ext,vietnamese" rel="stylesheet">
<link href="{{url('public')}}//fonts.googleapis.com/css?family=Montserrat:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&amp;subset=latin-ext,vietnamese" rel="stylesheet">
<!-- //googlefonts -->
				...
				{{-- <div class="top">
					<div class="container">
							...
							<div class="col-md-6 top-left">
								<ul>
									<button><a href="{{url('login')}}" class="btn btn-primary"> Admin</a></button> 
								</ul>
							</div>
					...
					<div class="header">
						<nav class="navbar navbar-default">
							<div class="navbar-header navbar-left">
								...
								<h1><a class="navbar-brand" href="{{url('template')}}">KETAPANG TRAVEL GUIDE</span></a></h1>
							</div>
							<!-- Collect the nav links, forms, and other content for toggling -->
							<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
								<nav class="cl-effect-15" id="cl-effect-15">
									<ul class="nav navbar-nav">
										<li class="active"><a href="{{url('template')}}">Desa Wisata</a></li>
													<li><a href="{{url('atraksiWisata')}}">Atraksi Wisata</a></li>
													<li><a href="booking.html">Kalender Wisata</a></li>
													<li><a href="gallery.html">Peta Wisata</a></li>
													<li><a href="gallery.html">Info & Kontak</a></li>
									</ul>
								</nav>
							</div>
						</nav>
	...
	{{-- <div class="two-grids">
		<div class="container">
			<div class="wthree_head_section">
				<h5 class="w3l_header">Desa Wisata Kabupaten Ketapang</h5>
			</div>
...
<!-- pricing -->
	<div class="w3ls-section wthree-pricing" id="pricing">	
		<div class="container">
			<div class="wthree_head_section">
				<h3 class="w3l_header">Desa Wisata Kabupaten Ketapang</h3>
			</div>
			<div class="pricing-grids-info">
								<div class="pricing-grid grid-one">
									<div class="w3ls-top">
										<img src="{{url('public')}}/images/g8.jpg" class="img-responsive" alt="">
									</div>
								...
								<div class="pricing-grid grid-two">
									<div class="w3ls-top">
										<img src="{{url('public')}}/images/g4.jpg" class="img-responsive" alt="">
									</div>
									<div class="w3ls-bottom">
										<ul class="count">
											<h3>Newyork</h3>
								...
								<div class="pricing-grid grid-three">
									<div class="w3ls-top">
										<img src="{{url('public')}}/images/g5.jpg" class="img-responsive" alt="">
									</div>
									<div class="w3ls-bottom">
										<ul class="count">
											<h3>Australia</h3>
								...
								<div class="zb pricing-grid grid-four">
									<div class="w3ls-top">
										<img src="{{url('public')}}/images/g11.jpg" class="img-responsive" alt="">
									</div>
									<div class="w3ls-bottom">
										<ul class="count">
											<h3>Dubai</h3>
