              ...
              <p>
                ...
                <li class="nav-item">
                    <a href="{{ url('backend/admin') }}"
                        class="nav-link {{ request()->is('backend/admin') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ url('backend/DesaWisata') }}"
                        class="nav-link {{ request()->is('backend/DesaWisata') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ url('backend/AtraksiWisata') }}"
                        class="nav-link {{ request()->is('backend/AtraksiWisata') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ url('backend/KalenderWisata') }}"
                        class="nav-link {{ request()->is('backend/KalenderWisata') ? 'active' : '' }}">
