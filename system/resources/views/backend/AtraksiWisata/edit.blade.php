        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('backend/AtraksiWisata', $atraksi_wisata->id) }}" method="post"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="no_pengelola"
                                            value="{{ $atraksi_wisata->no_pengelola }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="hari_buka"
                                            style="text-align: center" value="{{ $atraksi_wisata->hari_buka }}">
                                    </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="jam_tutup"
                                            value="{{ $atraksi_wisata->jam_tutup }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="float"  class="form-control" name="lat"
                                            id="latitude" value="{{ $atraksi_wisata->lat }}">
                                        <br>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="float"  class="form-control" name="lng"
                                            id="longitude" value="{{ $atraksi_wisata->lng }}">
                                        <br>
                                    </div>
                                </div>
