        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('backend/DesaWisata', $desa_wisata->id) }}" method="post"
                            ...
                            <div class="row">
                                    ...
                                    <div id="map"
                                        style="width: 80%; height: 300px;margin-left:auto;margin-right:auto"></div>
                                </div>
