        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('backend/KalenderWisata', $kalender_wisata->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="foto" accept=".jpg" value="{{$kalender_wisata->foto}}">
                                    </div>
                                </div>
                            </div>
                            <br>
